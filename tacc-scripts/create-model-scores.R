...
##    model - name of analysis (hosp1, hosp2, death, case)
...
# analysis_name = 'hosp1'; model_combo = 186; metric = 'hosp'
library(tidyverse)
...
# Create model-specific results for all dates ---------------------------------------------
