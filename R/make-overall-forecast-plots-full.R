...
my_overall
save_plot( filename = 'figs/multiyear-overall-full.png', 
           my_overall,
           base_height = 5,
           base_asp = 1.5,
           bg = 'white')
...
covidcase_overall
save_plot( filename = 'figs/covidcase-overall-full.png', 
           covidcase_overall,
           base_height = 5,
           base_asp = 1.5,
           bg = 'white')
...
covidadmits_overall
save_plot( filename = 'figs/covidadmits_overall-overall-full.png', 
           covidadmits_overall,
           base_height = 5,
           base_asp = 1.5,
           bg = 'white')
...
coviddeaths_overall
save_plot( filename = 'figs/coviddeaths_overall_overall-overall-full.png', 
           coviddeaths_overall,
           base_height = 5,
           base_asp = 1.5,
           bg = 'white')
...
fluadmits_overall
save_plot( filename = 'figs/fluadmits_overall_overall-overall-full.png', 
           fluadmits_overall,
           base_height = 5,
           base_asp = 1.5,
           bg = 'white')
...
save_plot('figs/overall-summary-fig-full.png', 
          panel_plot, 
          base_height = 7, 
          base_asp = 1.7,
          bg='white')
...
save(my_overall,
     ...
     fluadmits_overall,
     panel_plot,
     file = 'figs/ggplot-objects/overall-summary-figs-full.rda')
