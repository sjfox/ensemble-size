...
combine_model_score_summaries(analysis_name = '2023flu',
                              folder_path = 'processed-data/2023flu-analysis',
                              mod_info_path = 'raw-data/2023flu-model-combination-lookup-table.csv',
